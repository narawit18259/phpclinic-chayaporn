...
<body onload="startTime()" id="gradient">
    <div class="fonttext">
        ...
        <div class="animate__animated animate__fadeIn">
            <label style="margin: 20px 0px 0px 0px;"></label>
            <form method="post" action="editexroomsave.php">
                <div style="margin-bottom: 20px;">
                    <div class="container">
                        <div class="jumbotron">
                            <div style="text-align: center; font-size :30px; margin-bottom:20px;">
                                <a>แก้ไขข้อมูลการรักษา</a>
                            </div>
                            <div style="text-align:center;">
                                ...
                                <div class="form-inline" style="font-size:20px;"><br>
                                    ...
                                    <input type="number" class="form-control" name="weight" id="weight" aria-describedby="weight" required maxlength="3" value="<?php echo $result["weight"]; ?>">

                                    <label for="height" style="margin:0px 10px 0px 10px;">ส่วนสูง :</label>
                                    <input type="number" class="form-control" name="height" id="height" aria-describedby="height" required maxlength="3" value="<?php echo $result["height"]; ?>">

                                    <label for="perssure" style="margin:0px 10px 0px 10px;">ความดัน :</label>
                                    <input type="number" class="form-control" name="perssure" id="perssure" aria-describedby="perssure" required maxlength="8" value="<?php echo $result["perssure"]; ?>">
                                </div>

                                <label for="symptoms" style="margin-top:20px ; font-size:20px;">อาการ :</label>
                                <textarea class="form-control" id="symptoms" rows="5" input type="text" name="symptoms" value="<?php echo $result["symptoms"]; ?>"></textarea><br>
                                <div class="col-sm">
                                    ...
                                    <div class="col-75"><br>
                                        <div class="form-inline" style="font-size:20px;">
                                            ...
                                            <input type="date" class="form-control" name="date_appointment" id="date_appointment" aria-describedby="date_appointment" maxlength="8" value="<?php echo $result["date_appointment"]; ?>">
                                        </div>
