...
$row = $_GET['ID'];
$query = "DELETE FROM newcase WHERE ID='$row'";
...
<body onload="startTime()" id="gradient">
    <div class="fonttext">
        ...
        <div class="container-fluid">
            <div class="jumbotron">
                <h2 style="text-align: center; margin:0px 0px 30px 0px;" class="h">ลบข้อมูลเสร็จสิ้น</h2>
                <table class="table table-striped">
                    <?php
                    $query = "SELECT * FROM newcase ORDER BY firstname asc" or die("Error:" . mysqli_error());
                    $result = mysqli_query($conn, $query);
                    //หัวข้อตาราง
                    echo "<tr align='center' bgcolor='#CCCCCC'><td>ชื่อ</td><td>นามสกุล</td><td>เบอร์โทรศัพท์</td><td>วันเดือนปีเกิด</td><td>อายุ</td><td>โรคประจำตัว</td><td>เพศ</td><td>แก้ไข</td><td>ลบ</td></tr>";
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td align='center'><a href='editdatacase.php?act=edit&ID=$row[0]' class='btn btn-outline-warning'>แก้ไข</a></td> ";
