...
<body onload="startTime()" id="gradient">
    <div class="fonttext">
        ...
        <div class="animate__animated animate__bounceIn">
            <div style="text-align: right;margin:30px 30px 0px 0px">
                <img src="pict/warning.png" width="40px" height="40px">
                <label style="color:#ffffff; font-size:20px;"> ถ้าเป็นผู้ป่วยใหม่ กรุณาเพิ่มข้อมูลก่อนน่ะครับ </label>
                <img src="pict/warning.png" width="40px" height="40px">
            </div>
            <label style="margin: 50px 0px 0px 0px;"></label>
            <div class="container">
                <div class="jumbotron">

                    <form action="examinationroom.php" method="GET" style="text-align: center;">
                    ...
                    <h2 style="text-align: center; margin-top:30px; margin-bottom:30px;" class="h">รายชื่อผู้ป่วย</h2>
                    <table class="table table-striped">
                        <?php

                        echo "<tr align='center' bgcolor='#CCCCCC'><td>ชื่อ</td><td>นามสกุล</td><td>เบอร์โทรศัพท์</td><td>วันเดือนปีเกิด</td><td>อายุ</td><td>โรคประจำตัว</td><td>เพศ</td><td>เพิ่มข้อมูล</td><td>แแสดงข้อมูล</td></tr>";
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td align='center'>" . $row["congenital"] .  "</td> ";
                            echo "<td align='center'>" . $row["sex"] .  "</td> ";
                            echo "<td align='center'><a href='exroom.php?ID=" . $row["id"] . "' class='btn btn-outline-success'>เพิ่มข้อมูล</a></td> ";
                            echo "<td align='center'><a href='exroomshowdata.php?ID=" . $row["id"] . "' class='btn btn-outline-info'>แสดงข้อมูล</a></td> ";
                        }
                        ?>
