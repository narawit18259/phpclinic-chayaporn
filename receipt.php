...
if (!$_SESSION['userid']) {
    ...
    $sql = "SELECT * FROM treatment inner join newcase on treatment.id = newcase.id order by treatment_id desc";
            ...
            <div class="animate__animated animate__bounceIn">
                ...
                <div class="container-fluid">
                    <div class="jumbotron">
                        ...
                        <form action="receipt.php" method="GET" style="text-align: center;">
                        ...
                        <table class="table table-striped">
                            ...
                            echo "<tr align='center' bgcolor='#CCCCCC'><td>ชื่อ</td><td>นามสกุล</td><td>เบอร์โทรศัพท์</td><td>วันเดือนปีเกิด</td><td>อายุ</td><td>เพศ</td><td>ปริ้นใบเสร็จ</td></tr>";
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td align='center'><a href='printPDF.php?ID=" . $row["id"] . "' class='btn btn-outline-success'>พิมพ์</a></td> ";
                            }
                            ?>
