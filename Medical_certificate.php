...
?>
    ...
    <head>
        <title>Medical certificate page</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
            ...
            <div class="animate__animated animate__bounceIn">
                ...
                <div class="container">
                    <div class="jumbotron">
                        ...
                        <form action="Medical_certificate.php" method="GET" style="text-align: center;">
                        ...
                        <table class="table table-striped">
                            ...
                            echo "<tr align='center' bgcolor='#CCCCCC'><td>ชื่อ</td><td>นามสกุล</td><td>เบอร์โทรศัพท์</td><td>วันเดือนปีเกิด</td><td>อายุ</td><td>โรคประจำตัว</td><td>เพศ</td><td>ปริ้นใบเสร็จ</td></tr>";
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td align='center'><a href='Medicalcertificateprint.php?ID=" . $row["id"] . "' class='btn btn-outline-success'>พิมพ์</a></td> ";
                            }
                            ?>
