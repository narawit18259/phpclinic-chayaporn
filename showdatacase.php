...
mysqli_query($conn, "INSERT INTO newcase (firstname, lastname, tel, birthday, age,  address, congenital, date_new, sex, ID_card)
                            VALUES ('$firstname', '$lastname', '$tel', '$birthday', '$age', '$address', '$congenital',NOW(), '$sex', '$ID_card')");
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container-fluid">
            <div class="jumbotron">
                ...
                <table class="table table-striped">
                    <?php
                    $query = "SELECT * FROM newcase ORDER BY firstname asc" or die("Error:" . mysqli_error($result));
                    $result = mysqli_query($conn, $query);

                    //หัวข้อตาราง
                    echo "<tr align='center' bgcolor='#CCCCCC'><td>ชื่อ</td><td>นามสกุล</td><td>เพศ</td><td>เบอร์โทรศัพท์</td><td>วันเดือนปีเกิด</td><td>อายุ</td><td>ที่อยู่</td><td>โรคประจำตัว</td><td>แก้ไข</td><td>ลบ</td></tr>";
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td align='center'><a href='deletedatacase.php?ID=$row[0]' class='btn btn-outline-danger' onclick=\"return confirm('คุณต้องการที่จะลบข้อมูลนี้หรือไม่? !!!' )\">ลบ</a></td> ";
                    }
                    mysqli_close($conn);
                    ?>
                </table>
