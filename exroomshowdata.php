        ...
        <div class="container-fluid">
            <div class="jumbotron">
                <table class="table table-bordered">
                    <?php
                    echo "<tr align='center' bgcolor='#CCCCCC'><td>วันที่เข้ารับการตรวจ</td><td>วันนัดครั้งถัดไป</td><td>ชื่อ</td><td>นามสกุล</td><td>อาการ</td><td>น้ำหนัก</td><td>ส่วนสูง</td><td>ความดัน</td><td>ฝังเข็มรมยา</td><td>ฝังเข็มความสวยงาม</td><td>ฝังเข็มลดความอ้วน</td><td>ครอบแก้ว</td><td>นวดทุยหนา</td><td>กัวซา</td><td>ยาจีน</td></tr>";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td align='center'>" . $row["weight"] . " กก.".  "</td> ";
                        echo "<td align='center'>" . $row["height"] . " ซม.". "</td> ";
                ...
                <div style="text-align: center; margin-top: 50px;">
                    <?php echo "<a href='exroom.php?ID=" . $strID . "' class='btn btn-outline-primary'>เพิ่มข้อมูล</a>"; ?>
                </div>
            </div>
        </div>
    </div>
